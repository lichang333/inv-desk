...
ideal_otc_price = 7.20

# calculating...
floating_income_origin = USDT_TOTAL_AMOUT * (ideal_otc_price - USDT_EVERYAGER_BUY_PRICE)
...
if floating_income < 0:
    print(cs(("理想卖价：" + str(ideal_otc_price)), "#F75959"))
    print(cs(("浮动盈亏：" + str(floating_income)), "#F75959"))

else:
    print(cs(("理想卖价：" + str(ideal_otc_price)), "#42FFA4"))
